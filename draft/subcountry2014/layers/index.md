...
| value range       | 0.839148 to 0.839148                               |
...
| value units       | pressure score                                                      |
| value range       | 0.1614164 to 0.1614164                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.1556259 to 0.1556259                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.8914548 to 0.8914548                               |
| global extraction | raster | equal:  |
...
| value units       | km^2                                                      |
| value range       | 7.176097 to 107.9283                               |
...
| value range       | -0.01087331 to -0.01087331                               |
...
| value units       | trend score                                                      |
| value range       | -0.007147871 to -0.007147871                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | 0.1342569 to 0.1342569                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | -0.08344344 to -0.08344344                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value range       | 0.01043372 to 0.3845114                               |
...
| value units       | pressure score                                                      |
| value range       | 0.07233239 to 0.07233239                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.1401662 to 0.1401662                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.00160235 to 0.00160235                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | value                                                      |
| value range       | 0.8026543 to 0.8026543                               |
...
| value units       | pressure score                                                      |
| value range       | 0.0006594382 to 0.04727955                               |
...
| value range       | 2438463392 to 463647173831                               |
...
| value units       | jobs                                                      |
| value range       | 64176.53 to 6773941                               |
...
| value units       | resilience score                                                      |
| value range       | 0.6528571 to 0.6528571                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | people                                                      |
| value range       | 59676.18 to 5109606                               |
...
| value units       | score                                                      |
| value range       | 0.01109251 to 0.4672506                               |
...
| value units       | pressure score                                                      |
| value range       | 0.1336577 to 0.1336577                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.3334176 to 0.3334176                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.0124059 to 0.0124059                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.172195 to 0.172195                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.6561798 to 0.6561798                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | km^2                                                      |
| value range       | 5795.092 to 213565.1                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | km^2                                                      |
| value range       | 25.4805 to 1003.96                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | km^2                                                      |
| value range       | 300.2675 to 4516.014                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | resilience score                                                      |
| value range       | 0.8081556 to 0.8081556                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.798405 to 0.798405                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | -0.183228 to -0.183228                               |
| global extraction | equal: global trends were applied equally to each region.  |
...
| value units       | jobs                                                      |
| value range       | 2545.854 to 319928.2                               |
